  ...
  return (
    <div className="border-[1px] border-neutral-20 rounded-[12px] flex flex-col items-center mt-[14px] space-y-4 bg-neutral-0 p-6">
      ...
      <div className="flex flex-col gap-[4px] w-[224px]">
        <Link
          href="/mypage"
          className="p-[3px] text-[12px] text-center font-semibold text-primary-80 rounded border border-primary-80 rounded-[6px]"
        >
          프로필 설정
        </Link>
        <Link
          href="/mypage/privacysetting"
          className="p-[3px] text-center font-semibold text-[12px] bg-primary-100 border-primary-100 text-neutral-0 rounded-[6px]"
        >
          개인 정보
        </Link>
      </div>
