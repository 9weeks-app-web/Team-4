    ...
    return (
        <div className="max-w-[1152px]">
            <div className="mb-[58px]">
                ...
                <div className="text-neutral-60 font-medium text-[14px]">프로필 완성도가 높을수록 더 많은 프로젝트 제안을 받을 수 있어요.</div>
            </div>
            ...
            <div className="mt-[110px] mb-[104px]">
                <div className="mb-[8px] flex flex-col">
                    ...
                    <div className="text-neutral-60 font-medium text-[14px] mt-[10px]">나를 소개하는 다양한 목록들을 채워나갈 수록, 프로젝트/스터디 참여 성공률이 올라갈 수 있어요.</div>
                </div>
            </div>
            <OneLineIntroduction />
