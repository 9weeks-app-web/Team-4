        ...
        <div className="flex">
          <div className="flex flex-col gap-y-[14px]">
            <div className="flex gap-x-[12px]">
              <button className="px-[10px] rounded-[6px] border-[1px] border-neutral-10 text-[14px] font-medium">
                프로젝트
              </button>
              <button className="px-[10px] rounded-[6px] bg-primary-10 text-[14px] text-primary-80 font-medium">
                마감 미설정
              </button>
            </div>
