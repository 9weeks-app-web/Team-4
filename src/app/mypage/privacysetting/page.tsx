  ...
  return (
    <div className="max-w-[1152px]">
      ...
      <div className="bg-white p-8">
        ...
        <button className="w-full mb-6 text-neutral-0 bg-primary-100 text-white font-bold py-2 px-4 rounded border-2">
          저장하기
        </button>
        <div className="mb-6">
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              <div className="text-m font-bold font-medium text-gray-900">
                채용제안하기 알림
              </div>
              <div className="text-sm font-medium text-neutral-50">
                ‘채용제안하기’의 알림을 설정할 수 있습니다.
              </div>
            </div>
            <input
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-sm font-medium text-neutral-50">
                ‘직무별 채팅방’의 알림을 설정할 수 있습니다.
              </div>
            </div>
            <input
              className="form-checkbox h-5 w-5 text-gray-600"
              id="serviceInfoConsent"
              type="checkbox"
            />
          </div>
        </div>
